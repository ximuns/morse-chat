...
function AboutHero() {
  const titleRef = useScrollParallax(-0.08)

  const descriptionRef = useScrollParallax(0.16)
  ...
  return (
    <section className="about-hero">
      ...
      <div className="about-hero__content">
        ...
        <div ref={titleRef} className="about-hero__title">
          <motion.span
            initial={{
              opacity: 0,
              x: -100,
        ...
        >
          MORSE.CHAT — приватное пространство, где общение возвращается к своему простому состоянию:
