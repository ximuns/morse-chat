    ...
    */
    ...
    return (
        <motion.span
            className={
                char === '.'
                    ? 'about-idea__morse-dot'
                    : 'about-idea__morse-dash'
            }
            style={{
                x,
                y,
...
function AboutIdea() {
    ...
    */
    ...
    const conversionOpacity = useTransform(
        scrollYProgress,
        [0.22, 0.3, 0.52, 0.66],
        [
            0,
    ...
    const conversionScale = useTransform(
        scrollYProgress,
        [0.24, 0.39, 0.57],
        [
            0.84,
    ...
    */
    ...
    const morseOpacity = useTransform(
        scrollYProgress,
        [0.48, 0.6, 0.81, 0.91],
        [
            0,
    ...
    return (
        ...
        >
            <div className="about-idea__sticky">
                ...
                >
                    <div className="about-idea__intro-label">
                        КАК ЭТО РАБОТАЕТ
                    </div>
                    ...
                    <p>
                        Сообщение начинается с мысли.
                        В MORSE.CHAT оно не меняет
                        смысл — только форму передачи.
                    </p>
                </motion.div>
                ...
                >
                    <div className="about-idea__message-label">
                        ТВОЁ СООБЩЕНИЕ
                    </div>
                    ...
                    <div className="about-idea__message-text">
                        Сначала это просто фраза.
                    </div>
                </motion.div>
                ...
                >
                    ...
                    <div className="about-idea__morse-message">
                        ПРИВЕТ, КАК ТЫ?
                    </div>
                    ...
                    <p className="about-idea__morse-description">
                        Теперь сообщение можно передать
                        через короткие и длинные импульсы.
                    </p>
                ...
                >
                    ...
                    <div className="about-idea__final-label">
                        ВОТ В ЧЁМ ИДЕЯ
                    </div>

                    <div className="about-idea__final-line">
                        ФОРМА
                    </div>
                    ...
                    <div className="about-idea__final-line about-idea__final-line--muted">
                        СМЫСЛ
                    </div>
                ...
                >
                    ...
                    <div className="about-idea__example-body">
                        ...
                        <div className="about-idea__example-word">
                            ПРИВЕТ
                        </div>

                        <div className="about-idea__example-arrow">
                            →
                        </div>

                        <div className="about-idea__example-code">
                            .--. .-. .. .-- . -
                        </div>
