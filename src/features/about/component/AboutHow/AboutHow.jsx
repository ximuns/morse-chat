    ...
    return (
        <section className="about-how">
            ...
            <div className="about-how__top">
                <div className="about-how__number">
                    05
                </div>

                <div className="about-how__label">
                    КАК ЭТО РАБОТАЕТ
                </div>

                <div className="about-how__status">
                    ПРОТОКОЛ СВЯЗИ
                </div>
            </div>
                ...
                <div className="about-how__visual">
                    ...
                    <AnimatePresence mode="wait">
                        ...
                        >
                            ...
                            <div className="protocol-scene__eyebrow">
                                {current.label}
                            </div>


                            <div
                                className="protocol-scene__morse"
                                aria-label={`Morse сигнал: ${current.title}`}
                            >
                                {current.morse
                                    .split(' ')
                                    .map((letter, letterIndex) => (
                                        <span
                                            key={`${current.id}-${letterIndex}`}
                                            className="morse-letter"
                                        >
                                            {letter
                                                .split('')
                                                .map(
                            ...
                            <div className="protocol-scene__title">
                                {current.title}
                            </div>


                            <p className="protocol-scene__description">
                                {current.description}
                            </p>
                    ...
                    <div className="protocol-corner protocol-corner--tl">
                        +
                    </div>

                    <div className="protocol-corner protocol-corner--tr">
                        +
                    </div>

                    <div className="protocol-corner protocol-corner--bl">
                        +
                    </div>

                    <div className="protocol-corner protocol-corner--br">
                        +
                    </div>
