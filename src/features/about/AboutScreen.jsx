    ...
    return (
        ...
        >
            ...
            <header className="about-top">
                <div className="about-top__logo">
                    MORSE.CHAT
                </div>

                <div className="about-top__label">
                    О НАС
                </div>

                <button
                    type="button"
                    className="about-top__back"
                    onClick={onBack}
                >
                    <span>НАЗАД</span>
                    <span className="about-top__back-arrow">
                        ↗
                    </span>
                </button>
            </header>
            ...
            <footer className="about-footer">
                ...
                <div className="about-footer__subtitle">
                    ОБЩАЙТЕСЬ БЕЗ ШУМА.
                </div>

                <button
                    type="button"
                    className="about-footer__back"
                    onClick={onBack}
                >
